...
const Profile: React.FC = () => {
  ...
  // While viewing another account, never fall back to the admin's own login email.
  useEffect(() => {
    setForm({
      ...emptyProfile,
      ...(profile ?? {}),
      professionalName: profile?.professionalName || teamName,
      email: profile?.email || (readOnly ? '' : userEmail) || '',
    });
  }, [profile, userEmail, readOnly, teamName]);
